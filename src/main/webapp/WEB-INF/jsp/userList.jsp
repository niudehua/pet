		...
		<table width="800px" border='1' align="center">
			...
			<c:forEach items="${pageBean.list}" var="user" varStatus="st">
				<tr align="center">
					...
					<td><img width="40px" height="40px" src="${pageContext.request.contextPath}/${user.photo}" /></td>
					<td>${user.username}</td>
					<td>${user.nickname}</td>
					...
					<td><a href="${pageContext.request.contextPath }/toUpdate.do?id=${user.id}">修改</a></td>
				</tr>
			</c:forEach>
			<tr>
				<td colspan="10" align="center">第${pageBean.currPage }/${pageBean.totalPage }页&nbsp;&nbsp;&nbsp;&nbsp; 总记录数:${pageBean.totalCount }&nbsp;&nbsp;每页显示记录数:${pageBean.pageSize }&nbsp;&nbsp;
					...
					</c:forEach> &nbsp;&nbsp; <c:if test="${pageBean.currPage !=pageBean.totalPage&&pageBean.totalPage!=0 }">
